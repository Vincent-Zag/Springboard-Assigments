...
// You are provided with an array of numbers. 
// Your task is to filter out all the numbers that are less than 10 
// and create a new array containing only those numbers. Print the new array.

movies.forEach(function(movie){
	console.log(`${movie.title} Directed by: ${movie.director} released on: ${movie.yearReleased}`);
});