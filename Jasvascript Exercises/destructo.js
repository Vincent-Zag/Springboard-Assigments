...
console.log("Key places:",first,"and",second);
...
console.log("Elements:",firstElement,secondElement);
...
console.log("First and Sixth Stone:",firstStone,sixthStone);
...
const[visibleShadow, ...restShadows] = shadows;
console.log(visibleShadow,restShadows);
...
function revealPath ({direction,distance}){
    console.log("From the:",direction,"Move:",distance);
};
revealPath({direction: "South", distance: 3000});
...
mixPotion({ingredient1: "apples",ingredient2: "caramel" })
...
castSpell(["fart","chocolate","perfume"])
...
const { outer: { inner: fkey}} = nestedSecret;
console.log(fkey);
...
console.log("before stones swapped:",stoneA,stoneB);
[stoneA,stoneB] = [stoneB,stoneA];
console.log("after stones swapped:",stoneA,stoneB);